...
###### Tip Jar
The tip jar is based on [this repository](https://github.com/Marc26z/NostrTipJars) I made to help people who work at businesses that accept bitcoin to accept bitcoin tips. I use `lightning:fullreserve@getalby.com` for the QR code, but if you're not technical you can use any lightning address you have listed on Primal and take a screenshot of the lightning address QR code. The QR code doesn't work becaues I changed the size of the photo.
